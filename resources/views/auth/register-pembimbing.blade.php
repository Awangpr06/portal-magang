...
<head>
    ...
    <title>Pendaftaran Akun Pembimbing Akademik</title>
    <style>
        * {
        ...
        .page {
            ...
            padding: 32px 18px;
            background:
                linear-gradient(135deg, rgba(14, 99, 136, 0.95), rgba(28, 132, 120, 0.92)) top / 100% 310px no-repeat,
                #f0f6f8;
        }
        ...
        .form-card {
            ...
            background: #fff;
            border-radius: 8px;
            box-shadow: 0 22px 50px rgba(9, 50, 68, 0.16);
            overflow: hidden;
        }
        ...
        textarea:focus {
            border-color: #0e6388;
            box-shadow: 0 0 0 3px rgba(14, 99, 136, 0.12);
        }
...
<main class="page">
    <header class="header">
        ...
        <h1>Pendaftaran Akun Pembimbing Akademik</h1>
        <p>Lengkapi data berikut untuk membuat akun pembimbing akademik.</p>
    </header>
    ...
    <form class="form-card" method="POST" action="{{ route('register') }}" enctype="multipart/form-data" novalidate>
        ...
        <div class="form-body">
            ...
            <section class="section">
                ...
                <div class="grid">
                    <div class="field">
                        ...
                        <input type="text" id="nidn_nip" name="nidn_nip" value="{{ old('nidn_nip') }}" required>
                        @error('nidn_nip') <span class="error">{{ $message }}</span> @enderror
                    </div>
                    <div class="field">
            ...
            <section class="section">
                <h2 class="section-title"><span>3</span> Data Institusi</h2>
                <div class="grid">
                    <div class="field">
                    ...
                    <div class="field full">
                        <label for="jabatan">Jabatan Akademik</label>
            ...
            <section class="section">
                ...
                <div class="upload-area">
                    ...
                    <div>
                        ...
                        <p class="help">jpg, jpeg, png (Max. 2MB)</p>
            ...
            <div class="validation-panel">
                ...
                <div>
                    ...
                    Seluruh form akan berwarna hijau jika data sudah benar dan terisi.
                </div>
            </div>
