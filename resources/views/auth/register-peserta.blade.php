...
<head>
    ...
    <title>Pendaftaran Akun Peserta Magang</title>
    <style>
        * { box-sizing: border-box; margin: 0; padding: 0; }
        body { min-height: 100vh; font-family: Arial, sans-serif; background: #f0f6f8; color: #173241; }
        .page { min-height: 100vh; padding: 32px 18px; background: linear-gradient(135deg, rgba(98,190,66,.96), rgba(55,150,42,.9)) top / 100% 310px no-repeat, #f3fff0; }
        ...
        .section-title span { width: 30px; height: 30px; display: inline-flex; align-items: center; justify-content: center; border-radius: 8px; background: #62be42; color: #fff; font-weight: 700; }
        ...
        input:focus, textarea:focus { border-color: #62be42; box-shadow: 0 0 0 3px rgba(98,190,66,.16); }
        .field.valid input, .field.valid textarea { border-color: #2fb36f; background: #f3fff8; }
        .password-wrap { position: relative; }
        .password-wrap input { padding-right: 48px; }
        .toggle-password { position: absolute; right: 8px; top: 50%; transform: translateY(-50%); border: 0; background: #efffe9; color: #347822; border-radius: 8px; width: 34px; height: 34px; cursor: pointer; font-weight: 700; }
        ...
        .file-button { display: inline-block; background: #62be42; color: #fff; border-radius: 8px; padding: 12px 16px; font-weight: 800; cursor: pointer; }
        ...
        .btn-primary { background: #62be42; color: #fff; }
...
<main class="page">
    <header class="header">
        ...
        <h1>Pendaftaran Akun Peserta Magang</h1>
        <p>Lengkapi data berikut untuk membuat akun peserta magang.</p>
    </header>
    ...
    <form class="form-card" method="POST" action="{{ route('register') }}" enctype="multipart/form-data" novalidate>
        ...
        <div class="form-body">
            ...
            <section class="section">
                <h2 class="section-title"><span>2</span> Data Identitas Peserta</h2>
                <div class="grid">
                    <div class="field">
            ...
            <section class="section">
                <h2 class="section-title"><span>3</span> Data Akademik</h2>
                <div class="grid">
                    <div class="field">
                        <label for="perguruan_tinggi">Perguruan Tinggi</label>
                        <input type="text" id="perguruan_tinggi" name="perguruan_tinggi" value="{{ old('perguruan_tinggi') }}" required>
                    </div>
                    <div class="field">
                    ...
                    <div class="field">
                        ...
                        <input type="text" id="program_magang" name="program_magang" value="{{ old('program_magang') }}" required>
                    </div>
                    <div class="field full">
                        <label for="pembimbing_akademik">Pembimbing Akademik</label>
                        <input type="text" id="pembimbing_akademik" name="pembimbing_akademik" value="{{ old('pembimbing_akademik') }}" required>
                    </div>
                </div>
            </section>

            <section class="section">
                <h2 class="section-title"><span>4</span> Data Pelaksanaan Magang</h2>
                <div class="grid">
                    <div class="field">
                        <label for="tanggal_mulai_magang">Tanggal Mulai Magang</label>
                        <input type="date" id="tanggal_mulai_magang" name="tanggal_mulai_magang" value="{{ old('tanggal_mulai_magang') }}" required>
                    </div>
                    <div class="field">
                        <label for="tanggal_selesai_magang">Tanggal Selesai Magang</label>
                        <input type="date" id="tanggal_selesai_magang" name="tanggal_selesai_magang" value="{{ old('tanggal_selesai_magang') }}" required>
                    </div>
                </div>
            </section>

            <section class="section">
                <h2 class="section-title"><span>5</span> Upload Dokumen</h2>
